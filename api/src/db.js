...
const { Foundation, Pet, News, Product, Request, User, Donations } = sequelize.models;
...
// RELACION 1:N (Foundation - Request- User)
Foundation.hasMany(Request);
...
Donations.belongsTo(Foundation);
Foundation.hasMany(Donations);
